...
export const NAV_ICONS = {
  ...
  phoneCall: (
    <svg {...base} aria-hidden>
      <path d="M15 8a3 3 0 0 1 3 3M15 4a7 7 0 0 1 7 7" />
      <path d="M4.5 3h3l1.5 4-2 1.5a11 11 0 0 0 5.5 5.5L14 12l4 1.5v3a2 2 0 0 1-2.2 2A17 17 0 0 1 2.5 5.2 2 2 0 0 1 4.5 3Z" />
    </svg>
  ),
}
